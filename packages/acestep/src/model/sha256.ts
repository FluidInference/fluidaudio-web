...
/**
 * Bounded-memory incremental SHA-256 for model transport.
 *
 * This implementation is adapted from the MIT-licensed implementation in
 * ../parakeet.wgsl/src/model/sha256.ts at
 * 7ee112738262a6f5a0efd2f150748a4087432fbb.
 */
export class AceIncrementalSha256 {
  ...
  update(data: Uint8Array): this {
    ...
    if (!Number.isSafeInteger(this.totalBytes)) {
      throw new RangeError("SHA-256 input exceeds the safe integer range");
    }
...
export function aceSha256Hex(bytes: Uint8Array): string {
