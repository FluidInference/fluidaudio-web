...
P = 'encoder.bert.encoder.albert_layer_groups.0.albert_layers.0.'
E = 'encoder.bert.embeddings.'
out = {}
# embeddings
out['word_emb'] = init[E+'word_embeddings.weight']         # [178,128]
...
# 128->768 mapping
out['map_w'] = matmul_weight_for_bias('encoder.bert.encoder.embedding_hidden_mapping_in.bias')  # [128,768]
out['map_b'] = init['encoder.bert.encoder.embedding_hidden_mapping_in.bias']
# shared albert layer
