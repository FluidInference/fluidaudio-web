...
console.log(
  `ConvTranspose1d (Cin ${r.Cin}→Cout ${r.Cout}, L ${r.L}→${r.Lout}, K ${r.K}, stride ${r.stride}): max ${mx.toExponential(2)}  rel ${rel.toExponential(2)}`,
);
const ok = rel < 2e-2;
