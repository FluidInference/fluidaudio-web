...
//
// Default origin is the FluidInference HF mirror (byte-exact, SHA-256-verified
// copy of the author's R2 bucket; every payload prefix and manifest name is
// content-addressed and immutable, so origins are interchangeable). The
// original R2 origin remains usable via VITE_ACE_MODEL_ORIGIN:
//   https://ace-step-wgsl-models.narcotic.sh

export const ACE_DEFAULT_MODEL_ORIGIN = "https://huggingface.co/FluidInference/ace-step-webgpu-models/resolve/main";
